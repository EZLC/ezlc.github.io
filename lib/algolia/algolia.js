window.addEventListener("load", (()=>{
  const e = ()=>{
    ...
    , a = ()=>{
      ...
      $("#menu-search").on("click", (function() {
          ...
          a.initEvent("input", !0, !0),
          t.value = selectTextNow,
          t.dispatchEvent(a)
      }
      )),
      $(window).on("keydown", (function(t) {
          if (83 == t.keyCode && t.shiftKey && heo_keyboard) {
              if (selectTextNow) {
                  e();
                  let t = document.getElementsByClassName("ais-search-box--input")[0]
                    , a = document.createEvent("HTMLEvents");
  ...
  const n = instantsearch({
      ...
      searchFunction: function(e) {
          if (document.querySelector("#algolia-search-input input").value) {
              let t = '<div class="mxfont icon-spinner-solid fa-spin" style="font-size:22px"></div>';
              document.getElementById("algolia-hits").innerHTML = t,
              e.search()
          }
      }
  });
  n.addWidget(instantsearch.widgets.searchBox({
      container: "#algolia-search-input",
      reset: !1,
      magnifier: !1,
      placeholder: GLOBAL_CONFIG.algolia.languages.input_placeholder
  })),
  n.addWidget(instantsearch.widgets.hits({
  ...
  n.addWidget(instantsearch.widgets.stats({
      container: "#algolia-stats",
      templates: {
          body: function(e) {
              return "<hr>" + GLOBAL_CONFIG.algolia.languages.hits_stats.replace(/\$\{hits}/, e.nbHits).replace(/\$\{time}/, e.processingTimeMS) + '<span class="algolia-logo pull-right"></span>'
          }
      }
  })),
  n.addWidget(instantsearch.widgets.pagination({
